...
public class EngineTest {
    ...
    public void ConstructorTest() {
        ...
        MoveDirection[] tab = parser.parse(new String[]{"f", "forward", "r", "right", "right", "left", "backward", "b", "small", "kitty"});
        IWorldMap mapa = new RectangularMap(4, 4);
        Vector2d[] start_positions = {new Vector2d(2, 2), new Vector2d(2, 3), new Vector2d(2, 2)};
    ...
    @Test
    public void RunTest() {
        MoveDirection[] directions = new OptionsParser().parse(new String[]{"f", "forward", "r", "right", "right", "left", "backward", "b", "small", "kitty"});
